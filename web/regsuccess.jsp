...
.style15 {color: #ff3646; font-size: 36px; }
-->
</style>
</head>
<body>
        ...
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
              ...
              <h2 align="center" class="style15">Your Registration Success...!!! </h2>
              <ul>
                <li>
                  <h2 align="center" class="style11"><a href="userlogin.jsp">Click Here to Login...! </a></h2>
                </li>
              </ul>
              <p>&nbsp;</p>
              <div class="entry"></div>
